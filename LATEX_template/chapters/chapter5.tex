...
Để đánh giá hiệu năng của hai phương pháp SVD là LAPACK SVD~\cite{anderson1999lapack} và D\&C SVD, chúng ta đã thực hiện các thí nghiệm trên ma trận ngẫu nhiên với kích thước từ 100x100 đến 2000x2000. Kết quả thời gian tính toán được ghi lại và so sánh như sau:
\begin{figure}[H]
    \centering
