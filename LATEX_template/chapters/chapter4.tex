...
Nhân ma trận (Cannon) & $\approx 11.3$ & - & Tăng tốc siêu tuyến tính nhờ tối ưu cache (blocking). \\ \hline
Nhân ma trận (DNS) & $\approx 8.5$ & - & Hiệu quả với số luồng lập phương, chi phí truyền thông cao. \\ \hline
Jacobi & $\approx 4.4$ & - & Cần đồng bộ hóa liên tục, hiệu quả cao với $N \ge 1024$. \\ \hline
Giảm chiều dữ liệu với SVD & $\approx 4.6$ & - & Chỉ hiệu quả với dữ liệu lớn ($N > 3000$), overhead lớn ở $N$ nhỏ. \\ \hline
