...
\text{}\indent Để đánh giá hiệu năng của các thuật toán, chúng tôi sử dụng bộ dữ liệu gồm các ma trận được sinh ngẫu nhiên với kích thước và đặc điểm đa dạng. Quá trình sinh dữ liệu được thực hiện bằng ngôn ngữ Python với thư viện NumPy.
...
\paragraph{Các kích thước thử nghiệm:}
Chúng tôi đã tạo ra các bộ dữ liệu với kích thước tăng dần để kiểm tra khả năng mở rộng (scalability) của thuật toán. Các kích thước cụ thể bao gồm:
...
SVD Decomposition & $\approx 4.6$ & - & Chỉ hiệu quả với dữ liệu lớn ($N > 3000$), overhead lớn ở $N$ nhỏ. \\ \hline
