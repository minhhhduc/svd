...
Để đánh giá hiệu năng của các thuật toán, chúng tôi sử dụng bộ dữ liệu gồm các ma trận được sinh ngẫu nhiên với kích thước và đặc điểm đa dạng. Quá trình sinh dữ liệu được thực hiện bằng ngôn ngữ Python với thư viện NumPy.
