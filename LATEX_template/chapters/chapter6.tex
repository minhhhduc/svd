...
\begin{itemize}
    \item \textbf{Xây dựng thành công phiên bản song song của SVD:} Đã triển khai thuật toán \textit{Parallel Norm-Reducing Jacobi} để tính toán giá trị riêng và vector riêng cho ma trận hiệp phương sai. Thuật toán này đã được chứng minh là có khả năng hội tụ bậc hai và phù hợp với kiến trúc đa luồng.
