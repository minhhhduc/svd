...
\text{}\indent Nhân ma trận là một phép toán nền tảng trong nhiều ứng dụng tính toán khoa học, mô phỏng số và học máy. Với hai ma trận  
\[
...
\text{}\indent Thuật toán Cannon triển khai trên lưới xử lý hai chiều.  
...
\text{}\indent Thuật toán DNS sử dụng phân chia dữ liệu ba chiều, trong đó mỗi chiều tương ứng với một trong ba chỉ số \(i, j, k\) của phép nhân ma trận.  
